        ...
        <div className="relative">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <Image
              ...
              height={600}
            />
            <div className="absolute bottom-6 left-6 right-6 bg-white/70 backdrop-blur-[12px] border border-white/40 p-6 rounded-xl shadow-[0_10px_30px_-10px_rgba(0,108,73,0.1)]">
